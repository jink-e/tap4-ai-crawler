...
class WebsitCrawler:
    ...
    async def scrape_website(
        ...
        try:
            ...
            try:
                await page.goto(
                    url, {"timeout": 60000, "waitUntil": ["load", "networkidle2"]}
                )
            ...
            if manual_description:
                ...
                if not description:
                    ...
                    description = (
                        meta_description["content"].strip() if meta_description else ""
                    )
